...
def tsne_dimensionality_reduction():
    ...
    ##设置gmm函数
    gmm = GaussianMixture(n_components=20, covariance_type='full').fit(x)
    ##训练数据
    ...
    #     type = y_pred[i]
    #     with open("E:/zyt/junior1/DDS/FINAL-PROJECT/dataset/flows.txt/attack_pattern_flows/"+str(type)+".txt", "a") as fp:
    #         temp = []
